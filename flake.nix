{
  ...
  inputs = {
    ...
    mesa-downgrade.url = "github:NixOS/nixpkgs/a683adc19ff5228af548c6539dbc3440509bfed3";
...
#Desktop
	   ...
	   { hardware.graphics.package = inputs.mesa-downgrade.legacyPackages.x86_64-linux.mesa; }
           home-manager.nixosModules.home-manager
           {
             home-manager = {
               useGlobalPkgs = true;
